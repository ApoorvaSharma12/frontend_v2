...
const ManualEntry = () => {
  ...
  // Reset search and location filter
  const handleReset = () => {
    setSearchTerm('');
    setSelectedLocation('');
  };

  // Fetch location options and set current time on mount
  useEffect(() => {
  ...
  // Comparator function for descending sorting
